                ...
                <div className='sidebar p-3'>
                    ...
                    <ul className="nav flex-column mt-3 mb-3">
                        ...
                        <div className="sidebar-section">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link sidebar-link" to="manage-health-staff">
                                    <i className="fas fa-user-md me-2"></i> Manage Health Facility Staff
                                </Link>
                            </li>
                        </div>
                        <hr className="sidebar-divider" />
                        ...
                        <div className="sidebar-section ">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link sidebar-link" to="view-donations">
                                    <i className="fas fa-hand-holding-medical me-2"></i> View Donations
                                </Link>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link sidebar-link" to="center-data">
                                    <i className="fas fa-database me-2"></i> Center Data / Blood Stock
                                </Link>
                            </li>
                        </div>
                        <hr className="sidebar-divider" />

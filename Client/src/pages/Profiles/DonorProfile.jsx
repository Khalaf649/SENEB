...
export default function DonorProfile() {
  ...
  const handleSubmit = async () => {
    ...
    if (editableData.lastDonation) {
      updatedProfile.last_donation_date = new Date(
        editableData.lastDonation
      ).toISOString();
    }
        ...
        <div className="d-flex align-items-start mb-4">
          ...
          <div className="flex-grow-1">
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                <TextInput label="National ID" value={formData.id} disabled />
              </div>
              <div className="col-md-6 mb-3">
                <TextInput
                  label="Email"
              ...
              <div className="col-md-6 mb-3">
                <DateInput label="Birth Date" value={formData.dob} disabled />
              </div>
              <div className="col-md-6 mb-3">
                <SelectInput
                  label="Blood Type"
